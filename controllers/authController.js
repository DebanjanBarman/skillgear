...
exports.protect = catchAsync(async (req, res, next) => {
	...
	if (freshUser.changedPasswordAfter(decoded.iat)) {
		return next(new AppError("You recently changed your password Please log in with new password", 401))
	}
...
//3 Send it to user's email
	...
	const message = `Forgot Your password? use the link to reset your password \n
		${resetURL}\n
